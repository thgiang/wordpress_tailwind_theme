...
if ( ! defined( 'GTB_TYPOGRAPHY_CLASSES' ) ) {
    define(
        'GTB_TYPOGRAPHY_CLASSES',
...
function theme_enqueue_assets() {
    if (defined('WP_ENV') && WP_ENV === 'development') {
        ...
        wp_enqueue_style('theme-style', 'http://localhost:5173/assets/scss/style.scss', [], null);
        wp_enqueue_script('theme-main-js', 'http://localhost:5173/assets/js/main.js', [], null, true);

        // Đánh dấu script là module
        add_filter('script_loader_tag', function($tag, $handle) {
            if (in_array($handle, ['vite-client', 'theme-main-js'])) {
